<header class="header-pages mb-section header-padding-top dsn-container background-main">
    <div class="box-title ">
        <h1 class="title">
            <span class="letter-stroke">A Propos </span> <br>
            <span class="line-bg-left pl-80">de l'institut International des rêves</span>
        </h1>
...
<!-- ========== Service Section ========== -->
<section class="services pb-section background-section dsn-container p-relative " data-dsn-title="Our Service">
    <div class="section-title">
        <span class="tag-heading p-10 mb-15 background-main heading-color">Pourquoi nous ?</span>
...
<!-- ========== testimonials 2 ========== -->
<section class="testimonials testimonials-two dsn-container p-relative mb-section dsn-swiper" data-dsn-title="Clients See">
    <div class="section-title">
        <span class="tag-heading p-10 mb-15 background-section heading-color">
            Clients
        </span>
        <h2 class="heading-h2">Retours <br> de nos clients.</h2>
    </div>
...
<!-- ========== brand-client ========== -->
<div class="dsn-container brand-client background-section section-padding" data-dsn-title="Our Clients">
    ...
    <div class="section-title">
        ...
        <h2 class="heading-h2">
            Nos différentes <br> partenaires
        </h2>
    </div>
...
<div class="next-project h-v-100 section-top p-relative v-dark v-dark-head">
    ...
    <div class="dsn-container d-flex flex-column justify-content-center h-100">
        <div class="footer-content">
            <a href="#" class="effect-ajax has-box-mod move-circle" data-dsn="parallax" data-dsn-color="#284762" data-dsn-ajax="next">
                <h2 class="title">
                    Onirix, <br>les rêves deviennent réalités
                </h2>
            </a>
